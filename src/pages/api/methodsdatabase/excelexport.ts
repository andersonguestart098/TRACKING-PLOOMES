...
export default async function handler(
  ...
  workbook.creator = "Sistema Cemear";
  ...
  financeiro.columns = [
    ...
    {
      header: "Observações Financeiro",
      key: "observacaoFinanceiro",
      width: 22,
    },
  ];
  ...
  let ocorrencia = workbook.addWorksheet("Ocorrencia");
  const dataocorrencia = await prisma.ocorrencia.findMany({});

  ocorrencia.columns = [
    { header: "Id", key: "id", width: 10 },
    { header: "Data Criação", key: "data", width: 22 },
    { header: "Descricao", key: "descricao", width: 22 },
    { header: "Gravidade", key: "gravidade", width: 32 },
    { header: "Responsavel", key: "responsavel", width: 22 },
    { header: "Departamento", key: "departamento", width: 22 },
    { header: "Prioridade", key: "prioridade", width: 22 },
    { header: "Status", key: "status", width: 22 },
    { header: "Causa", key: "causa", width: 22 },
    { header: "Resolucao", key: "resolucao", width: 22 },
    { header: "Gerou Custo", key: "gerouCusto", width: 22 },
    { header: "Data Encerramento", key: "dataEncerramento", width: 22 },
    { header: "Especifique", key: "especifique", width: 22 },
    { header: "Observações", key: "obs", width: 22 },
  ];

  dataocorrencia.map((item, index) => {
    ocorrencia.addRow({
      id: item.id,
      data: item.createdAt,
  ...
  res.setHeader(
    "Content-Disposition",
    "attachment; filename=" + "CemearDadosTabelas.xlsx"
  );
  workbook.xlsx.write(res).then(function (data: any) {
    res.end();
