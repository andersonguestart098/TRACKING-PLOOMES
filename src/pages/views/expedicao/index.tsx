...
function index() {
  ...
  const { data, isLoading } = travarAuto ?
    useFetch<typeDB>("/api/methodsdatabase/getall", pagina, "expedicao", searchString) : 
              ...
              transition={{
                ...
                ease: [0, 0.71, 0.2, 1.01]
                  ...
                  style={
                    ...
                    item.statusNotaFiscal ==  "Em Separação" ? color.expedicao.emSeparacao : 
