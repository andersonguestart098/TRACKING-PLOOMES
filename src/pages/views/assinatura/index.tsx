    ...
    <>
      ...
      {data.result.length ? (
        <CustomTable
          ...
          childrenRowTable={data!.result.map((item: ModelAssinatura) => {
            return (
              <TableRow
              ...
              >
                ...
                <TableCell>
                  {item.responsavel != "a definir" ? (
                    <img
                      src={"/icones/" + item.responsavel.toLowerCase() + ".png"}
                ...
                <TableCell>
                  <img
                    onClick={() => setImgGigante(item.assinatura_img)}
                    src={item.assinatura_img}
                    width={30}
                  />
                </TableCell>
              </TableRow>
